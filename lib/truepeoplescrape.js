...
class TruePuppeteer extends base_puppeteer_1.BasePuppeteer {
    ...
    async restartWithNewProxy() {
        ...
        const proxyOpts = (0, exports.proxyStringToV2ray)(this.ln(await cycleProxy() || await buyProxy()));
        this.logger.info(proxyOpts);
        this.v2 = await (0, exports.makeV2ray)(proxyOpts, port, (0, exports.proxyStringToV2ray)(this.ln(await cycleIpv4Proxy())));
    ...
    async fetchPeopleRecursive({ depth }) {
        ...
        for (const char of alphabet) {
            const directory = path_1.default.join(cwd, char);
            process.chdir(directory);
            if (await fs_extra_1.default.exists(path_1.default.join(directory, "LOCK")) || await fs_extra_1.default.exists(path_1.default.join(directory, 'DONE')))
                continue;
            await fs_extra_1.default.writeFile(path_1.default.join(directory, "LOCK"), "");
            await this.constructNameIndex();
...
//# sourceMappingURL=truepeoplescrape.js.map